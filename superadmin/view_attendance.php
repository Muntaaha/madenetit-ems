                            ...
                            <div class="x_content">
								...
								<!-- table start-->
												  ...
												  if(isset($_GET['from']) && isset($_GET['to']))
												  {
													$from=$_GET['from'];
													$to=$_GET['to'];
													$prs="SELECT * FROM employee_attendance WHERE employee_attendance.entry_date BETWEEN '$from' AND '$to' ORDER BY login_id DESC";
												  }
												  else {
													$prs="SELECT * FROM employee_attendance ORDER BY login_id DESC";
												  }
