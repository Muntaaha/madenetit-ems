                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
							...
							<li><a href="task_assignment.php"><i class="fa fa-edit"></i>Task Assignment<span class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="view_task.php"><i class="fa fa-edit"></i>Receive Task<span class="fa fa-chevron-down"></span></a>

                            </li>
							<li><a href="pending_task.php"><i class="fa fa-table"></i> Pending Tasks <span class="fa fa-chevron-down"></span></a>

                            </li>
							<li><a href="rating.php"><i class="fa fa-table"></i> Rating <span class="fa fa-chevron-down"></span></a>
