            ...
            <div class="">
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Receive Pending Notification</h2>
                            ...
                            <div class="x_content">
                                <table class="table table-bordered">
									<tr>
										...
										<th style="text-align: center; font-size: 15px; padding: 10px; color: #fff; background-color: #2A3F54;">View Task</th>
									</tr>
									
									<?php 
									$res1=mysqli_query($connect,"select * from task where Employee_Name= '$_SESSION[username]'  && unread_msg_num ='n' ");
