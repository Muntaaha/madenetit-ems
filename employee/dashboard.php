                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_content">
								...
								<a class="quick-button"  href="view_employee.php">
								  ...
								  <button type="button" name="submit_arrival_time" id="submit_arrival_time" style="font-family: 'Comic Sans MS', cursive, sans-serif; font-weight: bold; font-size: 24px; background-color: #2A3F54;" class="btn btn-info btn-lg">Submit </button>
								  </a>
								  </div>
								  <?php
								  }
